  ...
  describe('compile', () => {
    describe('project filter', () => {
      it('filters events for the specified project', () => {
        const r = report.compile(events, { project: 'a', from: '2018-04-01', to: '2018-04-30' })
        expect(r).toEqual([events[0], events[2]])
      })

      it('allows all projects if no project is specified', () => {
        const r = report.compile(events, { from: '2018-04-01', to: '2018-04-30' })
    ...
    describe('member filter', () => {
      it('filters events for the specified member', () => {
        const r = report.compile(events, { member: 'x', from: '2018-04-01', to: '2018-04-30' })
        expect(r).toEqual([events[0], events[1]])
      })
    ...
    describe('story filter', () => {
      it('filters events for the specified story', () => {
        const r = report.compile(events, { story: '42', from: '2018-04-01', to: '2018-04-30' })
        expect(r).toEqual([events[0], events[1]])
      })
    ...
    describe('combined filters', () => {
      it('correctly filters project and story', () => {
        const r = report.compile(events, {
          project: 'a',
          story: '42',
          from: '2018-04-01',
          to: '2018-04-30',
        })
        expect(r).toEqual([events[0]])
      })
    ...
    describe('from/to filter', () => {
      it('default filters events for previous month', () => {
        ...
        expect(report.compile([...previousMonth, ...nextMonth], {})).toEqual([...previousMonth])
      })
    })
  })
})
